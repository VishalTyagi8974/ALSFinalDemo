    ...
    <div className="mobile-screen my-2 mx-auto" >
      <div className="position-relative">
        ...
        <div className=' d-flex justify-content-center mt-0'>
          ...
          <img src="homePage/calculator/ALS.png" className='rounded-4 shadow mb-3 ' width={100} height={100} alt="" />
        </div>
        {!showResults ? (
          <div className="d-flex justify-content-center flex-wrap fw-semibold para">
            <h6 className='text-black fw-semibold' >Calculate ITR</h6>
            <div className="mt-2  mb-2">
              ...
              <div className="input-group text-center ">
                ...
                <input type="number "
                  value={income}
                  onChange={handleIncomeChange} className="form-control fw-semibold " style={{ fontSize: "1rem", height: "35px" }} placeholder="Enter Amount" aria-describedby="basic-addon1" />
            ...
            <div className=" mt-3">
              ...
              <input type="number"
                ...
                className="form-control fw-semibold" style={{ height: "35px" }} placeholder="Enter Age" aria-describedby="basic-addon2" />
            ...
            <div className=" mt-3">
              ...
              <input type="number"
                ...
                className="form-control mb-4 fw-semibold" style={{ height: "35px" }} placeholder="Enter Deductions" aria-describedby="basic-addon3"
              />
          ...
          <div className="d-flex justify-content-center flex-wrap text-black fw-semibold">
            <h6 className='text-black w-100 text-center fw-semibold' >Estimated Tax</h6>
