...
const WhyAbout = () => {
    return (
        <div className={`why-us-section py-5  text-center w-100 mb-5 w-100`}>
            <section className=" mx-auto mainContainer">
                <h2 className="mb-5 display-6 fw-bold text-white">Why Choose Apka Legal Salahkar?</h2>
                <div className="row justify-content-center  my-4">
                    {whyChooseUs.map((item, idx) => (
                        <HoverCard textColor="white" styles={{ borderRadius: "50%", width: "235px", height: "240px" }} key={idx} title={item.title} hoverColor={"#9966ff"} animationData={item.icon}
                        />
                    ))}
                </div>
            </section>
