...
const TaxPlanning = () => {
    return (
        <div className='w-100 d-flex justify-content-center flex-wrap'>
            <div className='HeroTaxPlanningSection'></div>
                ...
                <div className=" text-start  position-relative mx-auto py-2 z-1 row  mainContainer" >
                    <div className=' col-lg-6 col-xl-7 px-0'>
                        <h1 className="secondMainColor display-1 fw-bold mb-4 mb-sm-3 ">
                            Tax Planning Made Simple, Savings Made Smarter
                        </h1>
                        <p className="para  mt-3 mb-4" style={{ fontSize: "1.1rem" }}>
                            Our expert-led tax planning solutions help you minimize your tax liability while maximizing your savings. Whether you’re salaried or self-employed, get personalized strategies that align with your financial goals.  </p>

                        <FocusButton focusElementId={"focusGenericForm"} buttonText={<>Starts at  &#x20b9;889</>} />

                    </div>
                    <div className=' col-lg-6 col-xl-5 px-0 '>
                        <div id="focusGenericForm" tabIndex="0" className='glowingElement mx-0 mx-md-4 rounded-4'>   <UserFormPage selectedOption={"Tax Planning"} isFixed={true} />
                        </div>
                    </div>
                </div>
            </section >
